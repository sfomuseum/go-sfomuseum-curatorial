...
require (
	...
	github.com/sfomuseum/go-sfomuseum-architecture v0.8.3
	github.com/sfomuseum/go-sfomuseum-feature v1.2.0
	github.com/sfomuseum/go-sfomuseum-reader v0.0.2
	github.com/sfomuseum/go-sfomuseum-writer/v3 v3.0.4
...
require (
	...
	github.com/sfomuseum/go-sfomuseum-export/v2 v2.3.12 // indirect
